...
namespace Babylon::Plugins::Internal
{
    ...
    void ContextDawn::PutImageData(const Napi::CallbackInfo& info)
    {
        ...
        {
            throw Napi::Error::New(env, "Context2D.putImageData: invalid number of parameters");
        }
        ...
        {
            throw Napi::Error::New(env, "Context2D.putImageData: the first argument is not an ImageData");
        }

        const auto srcWidthInt = imageData.Get("width").ToNumber().Int32Value();
        const auto srcHeightInt = imageData.Get("height").ToNumber().Int32Value();
        ...
        {
            throw Napi::Error::New(env, "Context2D.putImageData: the ImageData buffer is smaller than width*height*4");
        }
